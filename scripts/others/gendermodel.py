    ...
    if (!$('body.logged-in').length) {
      $('a.logged-in-only').hide().parent().next().find('a').css('padding-top','10px');
        ...
        <ul id="header-control">
                ...
                <li id="header-login">
                    <a href="/account/login?returnUrl=%2Faccount%2Flogin%3FReturnUrl%3D%252fc%252ftitanic%252fdownload%252fgendermodel.py" class="login-link">Login</a>
                </li>
        </ul>
